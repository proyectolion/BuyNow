...
public class PreguntasFragment extends Fragment {
    ...
    private PreguntasViewModel preuntasViewModel;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        final TextView textView = root.findViewById(R.id.text_preguntas);
        preuntasViewModel.getText().observe(getViewLifecycleOwner(), new Observer<String>() {
            @Override
